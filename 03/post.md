...
The complete source code is available on GitHub: [https://github.com/dimiro1/agent-from-scratch/tree/main/03](https://github.com/dimiro1/agent-from-scratch/tree/main/03)
...
![Markdown rendering](https://i.snap.as/kwvgOVoN.png)
